...
# ex : http://img.aitaotu.cc:8088/Pics/2015/0427/58/aitaotu_##.jpg
...
thd1 = threading.Thread(target=dojob,name='Thd1',args=(1,))
thd2 = threading.Thread(target=dojob,name='Thd2',args=(2,))
thd3 = threading.Thread(target=dojob,name='Thd3',args=(3,))
